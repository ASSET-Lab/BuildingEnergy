...
# usage         python3 eprun_s.py <city> <year> <climate> <directory>
# example       python3 eprun_s.py detroit 2040 rcp45 /home/user/epDir
...
# Source EP
ep_install_path = "/usr/local/EnergyPlus-23-2-0/" # Set to install path of EnergyPlus
...
for idf_id in idf_ids:
    ...
    output_path = tl_dir + '/output/' + city + '/' + climate + '/' + year + '/' + city + idf_id 
